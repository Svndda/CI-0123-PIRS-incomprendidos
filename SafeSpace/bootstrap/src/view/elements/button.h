 ...
 */
  ...
  /**
 * @brief Set the width and height of the button.
 * @param width Desired button width in pixels.
 * @param height Desired button height in pixels.
 */
  void setSize(int width, int height) {
    // Set the fixed dimensions for the button
    this->setFixedSize(width, height);
    
    // Ensure style is re-applied in case size impacts rendering
    this->applyStyle();
  };
