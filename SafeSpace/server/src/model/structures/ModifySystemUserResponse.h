#ifndef MODIFYSYSTEMUSERRESPONSE_H
#define MODIFYSYSTEMUSERRESPONSE_H
...
/**
 * @class ModifySystemUserResponse
 * @brief Response to ModifySystemUserRequest.
 * 
...
public:
  ...
  ModifySystemUserResponse() = default;

  ModifySystemUserResponse(uint8_t statusCode, const std::string& message) noexcept {
  ...
  static ModifySystemUserResponse fromBuffer(const uint8_t* data, size_t len) noexcept {
    ModifySystemUserResponse resp;
...
#endif // MODIFYSYSTEMUSERRESPONSE_H
